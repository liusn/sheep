...
#                            line = prompt(self.shellPrompt, completer = self.hint, style = DocumentStyle, history = history, on_abort = AbortAction.RETRY)
                            line = raw_input(self.shellPrompt)
                        except EOFError:
                            line = 'EOF'
                    else:
                        self.stdout.write(self.shellPrompt)
                        self.stdout.flush()
